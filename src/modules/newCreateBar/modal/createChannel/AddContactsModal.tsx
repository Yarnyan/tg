import { nextStepChannel, prevStepChannel } from "../../../../store/reducers/stepsSlice";
    ...
    return (
        <div className='w-full p-[16px] flex flex-col'>
            ...
            <div className="mt-[8px] flex justify-end">
                <button className="p-[16px] hover:bg-[var(--createModalHoverColorButton)] rounded-[20px] duration-500 text-[var(--createModalTextColorButton)] font-semibold text-[14px]" onClick={() => dispatch(prevStepChannel())}>Back</button>
                <button className="p-[16px] hover:bg-[var(--createModalHoverColorButton)] rounded-[20px] ml-[12px] duration-500 text-[var(--createModalTextColorButton)] font-semibold text-[14px]" onClick={() => dispatch(nextStepChannel())}>Create</button>
            </div>
        </div>
    );
}
